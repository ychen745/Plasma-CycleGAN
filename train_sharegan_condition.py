...
if __name__ == '__main__':
    ...
    def print_current_losses(epoch, i, losses, t, t_data):
        ...
        loss_msg = '%s,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f' %  (epoch, losses['D_A'], losses['G_A'], losses['cycle_A'], losses['idt_A'], losses['D_B'], losses['cycle_B'], losses['idt_B'])
    ...
    if opt.cross_validation:
        ...
        train_set = ConditionDataSet(opt.data_path, opt.data_split, which_direction='AtoB', transforms=trainTransforms, shuffle_labels=False, mode='train', condition=opt.condition)
