...
if __name__ == '__main__':
    ...
    if opt.cross_validation:
        train_set = NiftiDataSet(opt.data_path, True, opt.data_split, opt.fold, transforms=trainTransforms, mode='train')
        val_set = NiftiDataSet(opt.data_path, True, opt.data_split, opt.fold, transforms=None, mode='val')
    else:
        train_set = NiftiDataSet(opt.data_path, False, opt.data_split, transforms=trainTransforms, mode='train')
        val_set = NiftiDataSet(opt.data_path, False, opt.data_split, transforms=None, mode='val')
