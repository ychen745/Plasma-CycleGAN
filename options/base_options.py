...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--data_path', type=str, default='./rec_1_50/train/', help='Train images path')
        parser.add_argument('--name', type=str, default='CycleGAN3D_LPET_Reconstruction', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--val_path', type=str, default='./rec_1_50/test/', help='Validation images path')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./CycleGAN3D_check', help='models are saved here')
        ...
        parser.add_argument('--clinical', default='clinical.csv', type=str, help='Clinical datafile')
        ...
        parser.add_argument('--condition', type=str, help='Condition to add')
        parser.add_argument('--cross_validation', action='store_true', help='whether apply cross-validation')
        parser.add_argument('--alpha', type=float, default=0, help='SSIM loss alpha')
        parser.add_argument('--bbbm_mode', type=str, default='concat')
