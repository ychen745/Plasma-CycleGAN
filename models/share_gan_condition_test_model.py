...
from .share_gan_model import ShareGANModel


class ShareGANConditionTestModel(BaseModel):
    def name(self):
        return 'ShareGANConditionTestModel'

    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        assert not is_train, 'TestModel cannot be used in train mode'
        parser = ShareGANModel.modify_commandline_options(parser, is_train=False)
    ...
    def forward(self):
        self.fake_B = self.netG(self.real_A, 0.0, self.condition, True)
