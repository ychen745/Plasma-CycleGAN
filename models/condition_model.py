...
class ConditionModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            # parser.add_argument('--bbbm_mode', type=str, default='cb')
    ...
    def set_input(self, input):
        ...
        self.condition = input[2].to(self.device)

    def forward(self):
        self.fake_B = self.netG_A(self.real_A, self.condition, True)
        self.rec_A = self.netG_B(self.fake_B, self.condition, True)

        self.fake_A = self.netG_B(self.real_B, self.condition, True)
