...
from .medclip_model import MedClipModel
from transformers import AutoTokenizer
from torch.autograd import Variable


class Pix2Pix3dTestModel(BaseModel):
    def name(self):
        return 'Pix2Pix3dTestModel'

    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        assert not is_train, 'TestModel cannot be used in train mode'
        parser = MedClipModel.modify_commandline_options(parser, is_train=False)
