...
model = 'share_gan' if training else 'share_gan_test'
netg = 'ShareSynNet'

if training:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/train_sharegan.py'
else:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/test_sharegan.py'
