...
model = 'pe' if training else 'pe_test'
netg = 'pe'
if training:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/train_pe.py'
else:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/test_pe.py'
n_fold = 5
