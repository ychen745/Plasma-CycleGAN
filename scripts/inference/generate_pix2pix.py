...
model = 'pix2pix3d' if training else 'pix2pix3d_test'
netg = 'resnet_6blocks'

if training:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/train_pix2pix.py'
else:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/test_pix2pix.py'
