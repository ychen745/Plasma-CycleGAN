...
model = 'share_gan_condition' if training else 'share_gan_condition_test'
netg = 'ShareSynNet_condition'

if training:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/train_sharegan_condition.py'
else:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/test_sharegan_condition.py'
...
for which_epoch in which_epochs:
    ...
    for condition in conditions:
        for bbbm_mode in bbbm_modes:
            for i in range(1):
                exp_name = 'sharegan_c_' + condition + '_mid'
