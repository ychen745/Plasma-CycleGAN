...
model = 'condition' if training else 'condition_test'
netg = 'condition'
if training:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/train_cyclegan_condition.py'
else:
    python_path = '/scratch/ychen855/mri2pet/CycleGAN_3D/test_cyclegan_condition.py'
