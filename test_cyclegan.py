...
if __name__ == '__main__':
    ...
    for i in range(len(img_list)):
        ...
        inference_single(model, image_path, result_path, opt.resample, opt.new_resolution, opt.patch_size[0], opt.patch_size[1], opt.patch_size[2], opt.stride_inplane, opt.stride_layer, 1)
